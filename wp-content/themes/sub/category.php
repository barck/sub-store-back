...
<div class="main category-page">
    <div class="container">
      <div class="category-content">
        ...
        <h1><?php single_cat_title(); ?> учебники</h1>

        <?php query_posts('category__in='.$cat.'&meta_key=class&orderby=meta_value_class&order=ASC') ?>

        <div class="class-list">
        <?php $classListArray = array(); ?>
        <?php while (have_posts()) : the_post(); ?>
        <?php 
          $currentClass = get_field('class', $post_single);
        ?>
      ...
      <div class="sidebar">
        ...
        <?php
          ...
          <?php if($category->term_id === $thisCat->term_id):?>
            class="active-link"
          <?php endif;?>
          >
            <?= $category->name ?>
